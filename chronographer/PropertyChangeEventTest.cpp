...
int main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        IntPropertyInstance* inst = (IntPropertyInstance*)docObj.propList[0]->Instantiate( &session, docObj.charList[1] );
        ...
        class Add_1_Manipulator : public IntPropertyInstance::IManipulator
        {
        public:
            virtual Character* Source() { return NULL; }
            virtual void Manipulate( int& value ) { value++; }
        };
        inst->Manipulate( new Add_1_Manipulator() );
